...
use mongodb::options::{ReturnDocument, FindOneAndReplaceOptions, FindOneAndUpdateOptions};
...
pub fn delete_many_from_db(collection: Collection, filter:Document) ->Result<i8,ApiResponse>{
...
pub fn update_in_db<T:for<'de> Deserialize<'de>>(collection: Collection, id:i32, document:Document)->Result<T,ApiResponse>{
